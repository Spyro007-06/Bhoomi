...
export function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-center items-center px-4 py-2 sm:py-3 select-none overflow-x-hidden overflow-y-auto">
      ...
      <div className="relative z-10 my-auto w-full max-w-[420px] space-y-2.5 animate-bhm-fade-in-up">
        {/* Brand Identity Area */}
        <div className="text-center space-y-1.5">
          {/* Government Operations Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-950/50 backdrop-blur-md px-3 py-0.5 text-[10px] font-semibold tracking-wider text-emerald-200 shadow-sm">
          ...
          >
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/95 p-1 shadow-xl shadow-emerald-950/50 ring-2 ring-emerald-400/30 transition-transform duration-300 hover:scale-105">
              <img
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-[11px] sm:text-xs font-medium text-emerald-100/90 drop-shadow-xs max-w-sm mx-auto">
        ...
        <Card className="rounded-2xl border border-white/80 bg-white/95 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.35),0_1px_3px_rgba(0,0,0,0.08)] text-bhoomi-text-primary transition-all">
          <CardHeader className="space-y-0.5 pb-2 pt-3.5 px-5 sm:px-6">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <CardContent className="space-y-2.5 px-5 sm:px-6 pt-0.5">
              {generalError && (
                <div
                  role="alert"
                  className="rounded-xl bg-red-50/95 p-2.5 text-xs text-bhoomi-danger border border-red-200 flex items-start gap-2 shadow-xs animate-bhm-fade-in"
                >
              ...
              <div className="space-y-1">
                ...
                <div
                  ...
                  className="grid grid-cols-2 p-1 rounded-xl bg-slate-100/90 border border-slate-200/90 gap-1"
                >
                  <button
                    type="button"
                    role="radio"
              ...
              <Input
                ...
                className="h-9.5 bg-slate-50/70 focus:bg-white text-slate-900 placeholder:text-slate-400 border-slate-300/80 focus:border-emerald-600 focus:ring-emerald-600/20 rounded-xl transition-all"
              />
            ...
            <CardFooter className="flex flex-col gap-2 pt-1 pb-3 px-5 sm:px-6">
              <Button
                type="submit"
                className="w-full h-9.5 text-xs sm:text-sm font-semibold bg-[#1B5E20] hover:bg-[#14532D] active:bg-[#0F3E22] text-white shadow-md shadow-emerald-950/20 hover:shadow-lg active:scale-[0.99] transition-all duration-200 rounded-xl flex items-center justify-center gap-2 group"
              ...
              <div className="grid grid-cols-2 gap-2 w-full">
                <Button
                  ...
                  variant="secondary"
                  size="sm"
                  className="w-full h-8.5 flex items-center justify-center gap-1.5 text-xs font-semibold border border-slate-200 bg-slate-50/80 hover:bg-amber-50 hover:border-amber-300 hover:text-amber-950 text-slate-700 transition-all rounded-xl shadow-xs active:scale-[0.98]"
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full h-8.5 flex items-center justify-center gap-1.5 text-xs font-semibold border border-slate-200 bg-slate-50/80 hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-950 text-slate-700 transition-all rounded-xl shadow-xs active:scale-[0.98]"
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-slate-950/40 backdrop-blur-md px-3 py-1 text-[11px] font-medium text-emerald-100/80 border border-white/10 shadow-xs">
